...
#   s.public_header_files = 'Pod/Classes/**/*.h'
   ...
   s.subspec 'Addition' do |addition|
       addition.source_files = 'WebviewComponent/Classes/Addition/**/*'
       addition.dependency 'WebviewComponent/WebJSBridgeManage'
       addition.dependency 'WebviewComponent/Tools'
   end
