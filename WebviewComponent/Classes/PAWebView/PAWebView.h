...
typedef void (^TitleChangedBlock)(NSString *title);
typedef void (^socialShareBlock)(void);
...
@property (nonatomic,   copy) TitleChangedBlock titleBlock;
@property (nonatomic,   copy) socialShareBlock shareBlock;
