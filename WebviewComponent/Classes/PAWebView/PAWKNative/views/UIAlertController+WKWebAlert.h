 ...
 */
+ (NSArray *_Nullable)ba_ivarList;

#pragma clang diagnostic push
#pragma clang diagnostic ignored "-Wstrict-prototypes"

+ (void)PAlertWithTitle:(NSString *_Nullable)title message:(NSString *_Nullable)message completion:(void (^_Nullable)())completion;
+ (void)PAlertWithTitle:(NSString *_Nullable)title
                message:(NSString *_Nullable)message
           action1Title:(NSString *_Nullable)action1Title
           action2Title:(NSString *_Nullable)action2Title
                action1:(void (^_Nullable)())action1
                action2:(void (^_Nullable)())action2;
