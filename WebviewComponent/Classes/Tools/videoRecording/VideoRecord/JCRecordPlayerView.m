...
- (void)playerButtons{
    ...
    [_cancelButton setBackgroundImage:[UIImage imageWithContentsOfFile:[LLWebViewHelper pngImagefilePathForName:@"record_video_cancel"]] forState:UIControlStateNormal];
    ...
    [_confirmButton setBackgroundImage:[UIImage imageWithContentsOfFile:[LLWebViewHelper pngImagefilePathForName:@"record_video_confirm"]] forState:UIControlStateNormal];
