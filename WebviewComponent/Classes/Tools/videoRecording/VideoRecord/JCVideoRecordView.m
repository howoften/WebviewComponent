...
- (UIImageView *)focusImageView{
    if (!_focusImageView) {
        _focusImageView = [[UIImageView alloc]initWithImage:[UIImage imageWithContentsOfFile:[LLWebViewHelper pngImagefilePathForName:@"record_video_focus"]]];
...
- (UIButton *)backButton{
    if (!_backButton) {
        ...
        [_backButton setImage:[UIImage imageWithContentsOfFile:[LLWebViewHelper pngImagefilePathForName:@"record_video_back"]] forState:UIControlStateNormal];
...
- (UIButton *)switchCameraButton{
    if (!_switchCameraButton) {
        ...
        [_switchCameraButton setImage:[UIImage imageWithContentsOfFile:[LLWebViewHelper pngImagefilePathForName:@"record_video_camera"]] forState:UIControlStateNormal];
        _switchCameraButton.frame = CGRectMake(self.width - 20 - 28, [UIApplication sharedApplication].statusBarFrame.size.height + 20, 30, 28);
