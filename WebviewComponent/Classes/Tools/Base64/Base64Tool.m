...
-(NSString *)base64String {
    ...
    return [Base64Tool base64StringFromData:utf8encoding];
}

-(NSString *)base64UrlEncodedString {
    return [Base64Tool base64UrlEncodedStringFromBase64String:[self base64String]];
}

+(NSString *)stringFromBase64String:(NSString *)base64String {
    NSData *utf8encoding = [Base64Tool dataFromBase64String:base64String];
...
+(NSString *)stringFromBase64UrlEncodedString:(NSString *)base64UrlEncodedString {
    return [self stringFromBase64String:[Base64Tool base64StringFromBase64UrlEncodedString:base64UrlEncodedString]];
}
@end

@implementation NSData (Base64Addition)
+(NSData *)dataWithBase64String:(NSString *)base64String {
    return [Base64Tool dataFromBase64String:base64String];
}

+(NSData *)dataWithBase64UrlEncodedString:(NSString *)base64UrlEncodedString {
    return [self dataWithBase64String:[Base64Tool base64StringFromBase64UrlEncodedString:base64UrlEncodedString]];
}

-(NSString *)base64String {
    return [Base64Tool base64StringFromData:self];
}
